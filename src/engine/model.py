...
class Edge:
    ...
    """
    def __init__(self, source_id: Optional[str], target_id: Optional[str], trigger: Trigger, action: Optional[Action] = None, id: str = None, priority: int = 0, points: List[float] = None):
